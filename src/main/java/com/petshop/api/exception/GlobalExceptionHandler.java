...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<StandardError> appointmentConflict(AppointmentDateTimeAlreadyExistsException e, HttpServletRequest request) {
        return buildErrorResponse(
                e,
                HttpStatus.CONFLICT,
                "Conflict",
    ...
    private StandardError errorBody(
            String message,
            HttpStatus status,
            String error,
            String path
