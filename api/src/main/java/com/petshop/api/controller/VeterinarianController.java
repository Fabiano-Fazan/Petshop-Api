...
public class VeterinarianController {
    ...
    @PostMapping
    public ResponseEntity<VeterinarianResponseDTO> createVeterinarian(@Valid @RequestBody CreatedVeterinarianDTO createdVeterinarianDTO){
        VeterinarianResponseDTO createdVeterianrian = veterinarianService.createVeterinarian(createdVeterinarianDTO);
        return new ResponseEntity<>(createdVeterianrian, HttpStatus.CREATED);
    }
